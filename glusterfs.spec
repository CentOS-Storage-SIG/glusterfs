...
%if ( ! 0%{_for_fedora_koji_builds} )
find ./tests ./run-tests.sh -type f | cpio -pd %{buildroot}%{_datadir}/glusterfs
%endif
...
* Mon Aug 24 2015  Kaleb S. KEITHLEY <kkeithle[at]redhat.com> 3.6.5-1
- GlusterFS 3.6.5 GA

* Mon Jul 13 2015  Kaleb S. KEITHLEY <kkeithle[at]redhat.com> 3.6.4-1
- GlusterFS 3.6.4 GA

* Wed Apr 22 2015  Kaleb S. KEITHLEY <kkeithle[at]redhat.com> 3.6.3-3
- libacl-devel is not required for 3.6.3

* Wed Apr 22 2015  Kaleb S. KEITHLEY <kkeithle[at]redhat.com> 3.6.3-2
- BZ 1218359, 1218442
